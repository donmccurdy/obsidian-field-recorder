...
export class FieldRecorderSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl).setName("Audio quality").addDropdown((dropdown) =>
			dropdown
		...
		new Setting(containerEl).setName("Audio quality mode").addDropdown((dropdown) =>
			dropdown
		...
		new Setting(containerEl).setName("Audio format").addDropdown((dropdown) =>
			dropdown
				.addOptions(
